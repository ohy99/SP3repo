...
public:
	...
	Mtx44(Vector3 r, Vector3 u, Vector3 d, Vector3 p) {
		a[0] = r.x; a[1] = r.y; a[2] = r.z; a[3] = 0;
		a[4] = u.x; a[5] = u.y; a[6] = u.z; a[7] = 0;
		a[8] = d.x; a[9] = d.y; a[10] = d.z; a[11] = 0;
		a[12] = p.x; a[13] = p.y; a[14] = p.z; a[15] = 1;
	}
